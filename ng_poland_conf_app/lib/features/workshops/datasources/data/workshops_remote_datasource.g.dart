...
class _WorkshopsRemoteDataSource implements WorkshopsRemoteDataSource {
  _WorkshopsRemoteDataSource(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<WorkshopsModel> getWorkshops({
    ...
    final _options = _setStreamType<WorkshopsModel>(
    ...
    late WorkshopsModel _value;
    try {
      _value = WorkshopsModel.fromJson(_result.data!);
    } on Object catch (e, s) {
