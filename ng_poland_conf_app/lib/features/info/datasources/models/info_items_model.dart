...
@freezed
@HiveType(typeId: 3)
abstract class InfoItemsModel with _$InfoItemsModel {
  ...
  factory InfoItemsModel.fromJson(Map<String, dynamic> json) =>
      _$InfoItemsModelFromJson(json);

  List<InfoItem> toEntity() =>
      items?.map((infoItemModel) => infoItemModel.toEntity()).toList() ?? [];
}
