...
class _InfoRemoteDataSource implements InfoRemoteDataSource {
  _InfoRemoteDataSource(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<InfoItemsModel> getAllInfoItems({
    ...
    final _options = _setStreamType<InfoItemsModel>(
    ...
    late InfoItemsModel _value;
    try {
      _value = InfoItemsModel.fromJson(_result.data!);
    } on Object catch (e, s) {
