...
class _SpeakersRemoteDataSource implements SpeakersRemoteDataSource {
  _SpeakersRemoteDataSource(this._dio, {this.baseUrl, this.errorLogger});
  ...
  Future<SpeakersModel> getAllSpeakers({
    ...
    final _options = _setStreamType<SpeakersModel>(
    ...
    late SpeakersModel _value;
    try {
      _value = SpeakersModel.fromJson(_result.data!);
    } on Object catch (e, s) {
