...
import 'config/app_config.dart' as _i16;
...
// initializes the registration of main-scope dependencies inside of GetIt
  Future<_i1.GetIt> init({
    ...
    gh.singleton<_i15.WorkshopsLocalDataSource>(
        _i15.WorkshopsLocalDataSourceImpl());
    gh.singleton<_i16.AppConfig>(_i16.AppConfig(gh<_i7.RawConfig>()));
    gh.singleton<_i17.Dio>(registerModule.dio(gh<_i16.AppConfig>()));
    gh.factory<_i18.GetThemeMode>(
        () => _i18.GetThemeMode(gh<_i12.ThemeModeRepository>()));
    gh.factory<_i19.InfoRemoteDataSource>(
        () => _i19.InfoRemoteDataSource(gh<_i17.Dio>()));
    gh.singleton<_i20.InfoRepository>(_i21.InfoRepositoryImpl(
      gh<_i19.InfoRemoteDataSource>(),
      gh<_i5.InfoLocalDataSource>(),
    ));
    gh.factory<_i22.NgGirlsRemoteDataSource>(
        () => _i22.NgGirlsRemoteDataSource(gh<_i17.Dio>()));
    gh.singleton<_i23.NgGirlsRepository>(_i24.NgGirlsImpl(
      gh<_i22.NgGirlsRemoteDataSource>(),
      gh<_i6.NgGirlsLocalDataSource>(),
    ));
    gh.factory<_i25.ScheduleRemoteDataSource>(
        () => _i25.ScheduleRemoteDataSource(gh<_i17.Dio>()));
    gh.singleton<_i26.ScheduleRepository>(_i27.ScheduleRepositoryImpl(
      gh<_i25.ScheduleRemoteDataSource>(),
      gh<_i9.ScheduleLocalDataSource>(),
    ));
    gh.factory<_i28.SpeakersRemoteDataSource>(
        () => _i28.SpeakersRemoteDataSource(gh<_i17.Dio>()));
    ...
    gh.factory<_i31.WorkshopsRemoteDataSource>(
        () => _i31.WorkshopsRemoteDataSource(gh<_i17.Dio>()));
    gh.singleton<_i32.WorkshopsRepository>(_i33.WorkshopsRepositoryImpl(
      gh<_i31.WorkshopsRemoteDataSource>(),
      gh<_i15.WorkshopsLocalDataSource>(),
    ));
    gh.factory<_i34.ConferencesRemoteDataSource>(
        () => _i34.ConferencesRemoteDataSource(gh<_i17.Dio>()));
    gh.singleton<_i35.ConferencesRepository>(_i36.ConferencesRepositoryImpl(
      gh<_i34.ConferencesRemoteDataSource>(),
